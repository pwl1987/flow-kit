...
declare -A CORE_COMMANDS=(
  ...
  ["install"]="flow-kit/commands/install.md"
  ["code-review"]="flow-kit/commands/code-review.md"
  ["plan-generate"]="flow-kit/commands/plan-generate.md"
  ["tmux-init"]="flow-kit/commands/tmux-init.md"
  ["tmux-run"]="flow-kit/commands/tmux-run.md"
  ["tmux-aggregate"]="flow-kit/commands/tmux-aggregate.md"
  ["tmux-cleanup"]="flow-kit/commands/tmux-cleanup.md"
