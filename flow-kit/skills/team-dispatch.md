...
> v1.10 新增：验证每个 functional point 都有对应 Task

```
### Task-PRD 对齐检查

- PRD functional_points 总数：N
- 覆盖 Task 数：N
- FP 覆盖率：100%
- 未覆盖 FP：[列表]
```
...
| Task ID | 负责人 | 承诺交付 | 完成状态 |
|---------|--------|---------|---------|
| T1.1 | Dev | 2026-05-08 18:00 | ✅ |
| T2.1 | Reviewer | 2026-05-08 18:30 | 🔄 |

追责规则：
- 每个 Task 必须标注负责 Agent
- 延期时由负责人说明原因
- 禁止转移责任给其他 Agent
```
