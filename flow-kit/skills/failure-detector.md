...
> 来源：smallnest/autoresearch 自动迭代机制
...
|---------|---------|---------|
| **80+** | ✅ 通过 | 记录评分，任务完成 |
| **60-79** | ⚠️ L1 修复 | 触发结构化引导，提供调试清单，修复后重新评分 |
| **40-59** | 🔴 L2 注入 | 搜索 LESSONS.md 相似问题，强制 AI 阅读后重试 |
| **<40** | 🚨 L3 人工 | 暂停流程，向用户报告"AI 在任务 X 上反复失败"，等待人工介入 |

**最大迭代轮数**：3 轮（防止无限循环）
- 第 1 轮：评分 <80 → L1 修复
- 第 2 轮：仍 <80 → L2 注入 LESSONS
- 第 3 轮：仍 <80 → L3 人工介入，终止自动迭代

若连续 2 次 <80，直接触发 L3 人机协同。
