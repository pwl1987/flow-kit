...
flow-kit v3.7.0 — 面向 Claude Code 的结构化开发流程工具包，提供精简命令体系、9 阶段 (Phase 0-8) 开发工作流、棕地/绿地条件路由、护栏建议、会话记忆系统、YAML front matter 解析、auto-pilot 状态机、指标日志和单元测试。
